...
const ATRASO = 100; //Ciclo aumentado (fps)

const C_ALTURA = 500; //valor alterado. padrão: 300
const C_LARGURA = 500;  // valor alterado. padrão: 300
//*alturas devem ser alteradas no .html também
...
function fimDeJogo() {
    ...
    ctx.fillText("Fim de Jogo, Boa Sorte na proxima :)", C_LARGURA/2, C_ALTURA/2);
}
